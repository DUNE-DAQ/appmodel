...
ConfigObjectFactory::create(const std::string& class_name, const std::string& id) const
{
...
//---
conffwk::ConfigObject
ConfigObjectFactory::create_queue_sid_obj(const QueueDescriptor* qdesc, const confmodel::DetectorStream* stream) const
{
 ...
 */
conffwk::ConfigObject
ConfigObjectFactory::create_net_obj(const NetworkConnectionDescriptor* ndesc, std::string app_uid) const
{
