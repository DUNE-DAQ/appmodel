...
static confmodel::ModuleFactory::Registrator __reg__("FakeHSIApplication",
                                     ...
                                     const confmodel::Session* /*session*/) const
{
  ...
  if (rdrConf == 0) {
    throw(confmodel::BadConf(ERS_HERE, "No FakeHSIEventGeneratorModule configuration given"));
  }
