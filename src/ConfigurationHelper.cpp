...
ConfigurationHelper::get_netdescriptors(const std::string& data_type, const std::string& app_class)
{
  std::vector<std::pair<std::string, const appmodel::NetworkConnectionDescriptor*>> result;
...
std::vector<const confmodel::Service*>
ConfigurationHelper::get_services(std::string app_class, std::string data_type)
{
...
ConfigurationHelper::get_app_uids(std::string app_class)
{
...
bool
ConfigurationHelper::is_excluded(const conffwk::DalObject* item)
{
