...
nlohmann::json
CTBoardConf::get_ctb_json(const dunedaq::confmodel::Session& session, std::optional<std::string> socket_host) const
{
...
std::vector<const confmodel::ExcludableEntity*>
CTBMisc::contained_excludable_entities() const
{
  return std::vector<const confmodel::ExcludableEntity*>{ get_randomtrigger_1(), get_randomtrigger_2() };
}

nlohmann::json
CTBMisc::get_ctb_json(const dunedaq::confmodel::Session& session) const
{
  ...
  if (get_ch_status())
    ret[ch_status_flag] = true;
  else
    ret[ch_status_flag] = false;
...
nlohmann::json
CTBTrigger::get_ctb_json(const dunedaq::confmodel::Session& session) const
{
...
nlohmann::json
CTBSockets::get_ctb_json(std::optional<std::string> socket_host) const
{
...
nlohmann::json
CTBSocket::get_ctb_json(std::optional<std::string> socket_host) const
{
