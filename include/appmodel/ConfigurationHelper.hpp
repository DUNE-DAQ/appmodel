...
public:
  ...
  std::vector<std::pair<std::string, const appmodel::NetworkConnectionDescriptor*>> get_netdescriptors(
  ...
  inline bool is_included(const conffwk::DalObject* item) { return !is_excluded(item); }
