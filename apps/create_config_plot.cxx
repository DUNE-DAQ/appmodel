...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    appmodel::GraphBuilder graphbuilder(oksfilename, systemname);
    ...
    ers::fatal(appmodel::GeneralGraphToolError(ERS_HERE, errmsgstr.str()));
  ...
  } catch(const appmodel::GeneralGraphToolError& e) {
